...
contract TrinityContract{
    ...
    */
    function deposit(bytes32 channelId,
        ...
        require(verifyTransaction(channelId, nonce, funderAddress, funderAmount, partnerAddress, partnerAmount, funderSignature, partnerSignature) == true);

        /* if channel have existed, can not create it again*/
        require(trinityData.channelInfo[channelId].channelExist == false);
    ...
    function updateDeposit(bytes32 channelId,
        ...
        //transfer both special assets to this contract.
        require(Mytoken.transferFrom(funderAddress,this,funderAmount) == true);
        require(Mytoken.transferFrom(partnerAddress,this,partnerAmount) == true);
    ...
    */
    ...
    event WithdrawFailure(bytes32 channelId, address sender, address receiver);
